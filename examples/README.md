...
- `adder-mesh-service` – minimal stateless sample that exposes a simple `/add` endpoint. See `examples/adder-mesh-service/README.md` for usage.
...
- `mesh-rpc-demo` – three services chained via RabbitMQ request/response using `IMeshRpc` and MassTransit. See `examples/mesh-rpc-demo/README.md`.
