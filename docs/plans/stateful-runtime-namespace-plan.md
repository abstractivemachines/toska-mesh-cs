...
## Approach
- Public surface: introduce `ToskaMesh.Runtime.Stateful` with `MeshStatefulLambdaService.RunAsync(...)` and provider-neutral options; keep Orleans as the default provider behind nested provider options or an internal adapter.
