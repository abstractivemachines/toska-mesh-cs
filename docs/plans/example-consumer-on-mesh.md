...
- Scaffold consumer repo: minimal solution using package references only, `MeshLambdaService.RunAsync` with `/hello` endpoint and middleware example; keep in `examples/hello-mesh-service` or a separate repo.
